...
├── live_da3_small.py
├── webcam_depth_v3.py
├── webcam_depth_v3re.py
├── webcam_depth_v3rere.py
├── webcam_depth_v3rere_dep.py
└── captures_v3/
```
---
# Environment Setup
...
Depth Anything V3 실시간 추론 환경은 단계적으로 개선하였다.

---

## Version 1 : Initial Live Demo
...
- Jetson Orin NX에서 Depth Anything V3 실시간 동작 여부 검증
...
- 실시간 추론 성공
- Jetson 환경에서 V3 동작 확인

---

## Version 2 : Data Export
...
## Version 4 : Image Quality Improvement
...
본 프로젝트는 단순 모델 실행에 그치지 않고 실시간 추론, 데이터 저장, 성능 최적화, 화질 개선 및 Autofocus 응용까지 단계적으로 발전시켰다.
...
본 프로젝트에서는 Jetson Orin NX 환경에서 Depth Anything V3를 성공적으로 구동하였으며, 단일 이미지 추론부터 실시간 Webcam 기반 Depth Estimation, Autofocus Demo 구현, Docker 및 ROS2 Wrapper 적용 시도까지 수행하였다.
